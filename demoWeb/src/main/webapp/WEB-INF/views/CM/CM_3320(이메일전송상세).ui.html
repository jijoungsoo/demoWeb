...
<form name="msg_detail_area" style="border: 1px solid #ccc; padding: 10px; border-radius: 10px;">
  <div class="container">
      ...
      <div class="col">
        <div class="form-group">
          <div class="input-group">
            ...
            <input type="text" class="form-control" data-ax-path="SNDR_ADDR" disabled name="SNDR_ADDR">
          </div>
        </div>     
      </div>
    </div>
      ...
      <div class="col">
        <div class="form-group">
          <div class="input-group">
            ...
            <input type="text" class="form-control" data-ax-path="TTL" name="TTL" disabled>            
          </div>
        </div>     
      </div>
    </div>
    <div class="row">
      <div class="col tal">
            <div data-ax-path="CNTNT" name="CNTNT" style="min-height: 300px;"></div>
            <input type="button" name="search" value="검색" style="display: none;">
      </div>
    </div>
  </div>
</form>
