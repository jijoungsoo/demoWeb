<script>
  var KIW_1300 = function () {
    ...
    grid.addEvent("click",function (e, args, p_grid) {
      ...
      if (p_grid.getColumns()[cell.cell].id == "stock_cd") {
        ...
        var popup = new PopupManger(_this, 'KIW_1400'/*KIW_1400(주식종목상세(매도,매수))*/, {
          width: 1100,
          heght: 700
        },
          param
      ...
      if (p_grid.getColumns()[cell.cell].id == "stock_nm") {
        if (!p_grid.getEditorLock().commitCurrentEdit()) {
          return;
        }
        var rd = grid.dataView.getItem(cell.row);
        var param = {
          stock_cd: rd.stock_cd,
          stock_nm: rd.stock_nm,
        }
        goNextPage('KIW_1400', rd.stock_nm,param)
      }
    });
