...
import com.example.demo.interceptor.WebLoginChkInterceptor;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    @Autowired
    WebLoginChkInterceptor webLoginChkInterceptor;

    @Override
    public void addInterceptors(InterceptorRegistry registry) {
        /*
         * 사용안함 security 로 대체 registry.addInterceptor(certificationInterceptor)
         ...
         * .excludePathPatterns("/api/login") .excludePathPatterns("/out")
         * .excludePathPatterns("/*.js") .excludePathPatterns("/*.css")
         * .excludePathPatterns("/*.jpg") .excludePathPatterns("/*.png");
         * 
         */

        registry.addInterceptor(webLoginChkInterceptor).addPathPatterns("/*").excludePathPatterns("/login/*")
                .excludePathPatterns("/*.js").excludePathPatterns("/*.css").excludePathPatterns("/*.jpg")
